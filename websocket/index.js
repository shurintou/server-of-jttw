...
wss.on('connection',
    ...
    function connection(ws, req) {
        ...
        ws.on('message', async function incoming(data) {
            ...
            try {
                const session = await redis.get(conf.redisCache.sessionPrefix + req.sessionID)
                if (session === null) {
                ...
                await redis.pExpire(conf.redisCache.sessionPrefix + req.sessionID, conf.session.cookie.maxAge)
